...
public class Producto extends AppCompatActivity {
    ...
    private void registrarProductos() {
        ConexionSQLiteHelper conn = new ConexionSQLiteHelper(this, "bd_productos2", null, 1);
        ...
        Toast.makeText(getApplicationContext(), "Codigo Estudiante: " + idResultante, Toast.LENGTH_SHORT).show();
        db.close();
        edtNombre.setText("");
        edtProveedor.setText("");
        edtStock.setText("");
